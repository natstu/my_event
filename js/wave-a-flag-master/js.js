...
(function( window, document, $ ) {
	...
	function addWavableFlag() {
		...
		try {
			Wave.addWavableImage({ image_src : 'LCCs2016.png', canvas_id: 'flag-horizontal-canvas' });
			Wave.addWavableImage({ image_src : 'LCCs2016.png', canvas_id: 'flag-vertical-canvas' });
		} catch( e ) {
